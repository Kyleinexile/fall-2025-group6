...
# ============================================================================
    ...
    col2.metric("ESCO Alignment", "~20%")
    col3.metric("Default Model", "Gemini Flash")
    col4.metric("Token Limit", "1024 max")
...
# ============================================================================
    ...
    └─────────────────────────────────────────────────┘
        ↓
    Output: ~21 KSAs per AFSC, ~20% ESCO-aligned
    ```
    """)
...
# ============================================================================
    ...
    with st.expander("**Q: What's pypdf used for?**"):
        ...
        **A:** pypdf powers our "Try It Yourself" page, allowing users to:
        ...
        - Search 700+ page AFSC documents (AFECD/AFOCD)
...
# ============================================================================
    ...
    cost_data = pd.DataFrame({
        ...
        "Relative Cost": ["Lowest", "Low", "Medium", "Higher"],
        "Use Case": ["Skills only", "Skills + K/A", "Backup option", "Premium quality"],
        "Recommendation": ["✅ Default", "✅ If K/A needed", "⚠️ Backup", "⚠️ Premium only"]
    })
    st.dataframe(cost_data, use_container_width=True, hide_index=True)
    ...
    scaling_data = pd.DataFrame({
        ...
        "LAiSER Only": ["Minimal", "Minimal", "Low", "Low", "Low"],
        "LAiSER + LLM": ["Low", "Low", "Medium", "Medium", "Medium"]
    })
    ...
    **Dramatically more cost-effective than manual extraction!** 🎉
    """)
